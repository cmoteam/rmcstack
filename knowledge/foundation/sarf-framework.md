...
- `/ui-design` = 「UI/UX視点で、CVR改善基準で、修正後コード込みでレビューせよ」
...
| スキル | Design | Review |
|--------|--------|--------|
| `/cmo-review` | 戦略・チャネル設計 | 成果物の戦略整合性 |
| `/ceo-review` | — | GO / PIVOT / KILL |
| `/creative-direction` | — | APPROVE / REVISE / REWORK |
| `/seo` | キーワード戦略 | 技術監査・既存コンテンツ評価 |
| `/consultant-review` | ゼロベース再設計提案 | 前提・聖域・戦略のゼロベース率直レビュー |
| `/ui-design` | — | CVR観点のUI評価 |
...
| Set                  | Ask                 | Release        | Feedback        |
|----------------------|---------------------|----------------|-----------------|
| memory/company       | /cmo-review         | /contents-edit | /data-analytics |
| memory/results       | /ceo-review         | /ads-manager   | /weekly-retro   |
| knowledge/update     | /seo                | /landing-page  | /feedback       |
| knowledge/foundation | /ui-design          | /estimate      | → Setに還元     |
|                      | /creative-direction | （成果物出力＋本番反映） |       |
