# Narrative & Storytelling — ナラティブとストーリーテリング
...
- **Set**: 顧客のExternal/Internal/Philosophical Problem、ブランドのWhyを `memory/company/` に書く
- **Ask**: 「このメッセージをStoryBrand 7フレームで組み直して」「Before/Afterを1人の顧客で描写して」
- **Release**: LP・広告・メール・プレゼンのコピー、採用ストーリー、IRナラティブへ反映
- **Feedback**: メッセージのABテスト結果、記憶（認知アンケート）、共感指標を `knowledge/latest/` に記録
