...
| Activate / Delivery | `delivery-plan.md` | `private/output/<workspace>/YYYYMMDD-delivery-plan.md` | milestone、依存関係、blocker、shipping 日を管理する | 複数日・複数人・外部依存がある Activate 前 |
| Activate / Delivery | `stakeholder-map.md` | `private/output/<workspace>/YYYYMMDD-stakeholder-map.md` | 承認者、相談先、通知先、反対・懸念の所在を整理する | 承認・部門調整・顧客影響がある Activate 前 |
| Activate / Delivery | `risk-register.md` | `private/output/<workspace>/YYYYMMDD-risk-register.md` | リスク、trigger、mitigation、issue、escalation を継続管理する | High impact risk がある Activate 前後 |
| Activate / Delivery | `change-log.md` | `private/output/<workspace>/YYYYMMDD-change-log.md` | Scope / Budget / KPI / Schedule / Rollback の変更理由と承認者を残す | Activate 中に重要変更が発生した時 |
| Activate / Delivery | `resource-plan.md` | `private/output/<workspace>/YYYYMMDD-resource-plan.md` | 社内工数、外注、ツール、AI 委譲範囲、capacity risk を管理する | 工数・外注・AI 委譲が成果に影響する時 |
...
Activate / Delivery artifacts は PMBOK 由来の軽量補助線であり、RMC Core の必須条件ではない。ただし Standard / Full 運用、または複数人・複数日・外部依存・承認・高リスクを含む施策では、必要な artifact を shipping 前に作る。これにより RMC の軽さを保ちながら、PMBOK の governance / scope / schedule / finance / stakeholders / resources / risk 観点を Activate にだけ取り込む。
...
20260429-delivery-plan-meta-ads.md
20260429-risk-register-lp-abtest.md
```
