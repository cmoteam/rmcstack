...
特定企業が公開資料で対外的に明確化している、**固有名のついたマーケティング体系**を集めた知識ベース。一般理論（AARRR・STP・JTBD 等は `growth-frameworks.md`）ではなく、**企業ごとのオペレーティング・モデル**としてのフレームワーク。
...
- `knowledge/base/growth-frameworks.md` — 一般理論のフレームワーク（AARRR / STP / JTBD / RAM-CE）
