...
- **Set Preflight**: `private/memory/workspaces/active/results/performance-data.md` `private/memory/workspaces/active/profile/*` が存在する前提。未存在なら Step 0 でブートストラップ
...
- **後工程**: `/sarf-check`（更新後の状態確認）→ 次サイクルの `/cmo-review`
