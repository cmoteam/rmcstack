...
Phase 6: Measure      → /analytics（効果測定）→ knowledge/feedback/ に還元
```
...
- [ ] `knowledge/feedback/performance-data.md` に直近のベースライン数値があるか
...
キャンペーン終了時には、得られた知見を `knowledge/feedback/performance-data.md` に書き戻してサイクルを閉じてください。
