...
- **Set Preflight**: `icp.md` `brand-guidelines.md` が未整備だと Step 3 (ask-creative-director) のレビューが成立しない。開始前に `/saaf-check` を推奨
...
Step 3: /ask-creative-director — 品質・ブランド整合性のレビュー
Step 4: /ask-cmo   — 戦略整合性の最終確認
Step 5: Publish       — 公開チェックリスト
Step 6 (後工程): /analytics — 公開後のFeedback収集 → knowledge/results/ に反映
```
