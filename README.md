...
CMOFlow は、コーディングエージェント上で動作する **AI-Based Marketing OS** です。
...
CMOFlow が前提とする、AI 時代のマーケティングの基本サイクル:
...
```bash
git clone https://github.com/cmoteam/cmoflow.git
cd cmoflow
```
...
CMOFlow のマーケティングサイクルは、そのまま RMC のサイクルです:
