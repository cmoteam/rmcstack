...
- 生成ファイルのファイル名は原則 `YYYYMMDD-{skill}-{slug}.{ext}` を推奨（例: `20260419-contents-edit-hero-copy.md`）。
...
├── landing-page/         # /landing-page / /ui-design のHTML/CSS
├── seo/                  # /seo のKWリスト・監査レポート
├── analytics/            # /data-analytics のレポート
├── reviews/              # /ceo-review /cmo-review /consultant-review /creative-direction のレビュー
